  ...
  values: [
    {
      ...
      desc: `This <a href="https://www.w3.org/TR/css3-values/#number-value">&lt;number></a> component sets <a href="#section-flex-grow">flex-grow</a> <a href="https://www.w3.org/TR/css-flexbox-1/#flex-components">longhand</a> and specifies the <dfn id="flex-flex-grow-factor">flex grow factor</dfn>,
...
When omitted, it is set to <code>1</code>.
     <details class="note">
...
if items are added, removed, or line-wrapped.</p>
...

    {
      ...
      desc: `This <a href="https://www.w3.org/TR/css3-values/#number-value">&lt;number></a> component sets <a href="#section-flex-shrink">flex-shrink</a> <a href="https://www.w3.org/TR/css-flexbox-1/#flex-components">longhand</a> and specifies the <dfn id="flex-flex-shrink-factor">flex shrink factor</dfn>,
...
so that e.g. a small item won’t shrink to zero before a larger item has been noticeably reduced.</p>`
...

    {
      ...
      desc: `This component sets the <a href="#section-flex-basis">flex-basis</a> <a href="https://www.w3.org/TR/css-flexbox-1/#flex-components">longhand</a>,
...
The equivalent effect can be achieved by using <code>auto</code> together with a main size (<a href="https://www.w3.org/TR/CSS21/visudet.html#width">width</a> or <a href="https://www.w3.org/TR/CSS21/visudet.html#height">height</a>) of <a href="https://www.w3.org/TR/css-sizing-3/#valdef-width-auto">auto</a>.</p>
  ...
  <dt>
    <a href="https://www.w3.org/TR/CSS21/visudet.html#width">&lt;‘width’></a>
  ...
  <dd>
    ...
    {
      name: 'auto',
      alias: 'valdef-flex-basis-auto',
      desc: `When specified on a <a href="https://www.w3.org/TR/css-flexbox-1/#flex-item">flex item</a>, the <a href="#valdef-flex-basis-auto">auto</a> keyword
retrieves the value of the <a href="https://www.w3.org/TR/css-flexbox-1/#main-size-property">main size property</a> as the used <a href="#section-flex-basis">flex-basis</a>.
If that value is itself <a href="#valdef-flex-basis-auto">auto</a>, then the used value is <a href="#valdef-flex-basis-content">content</a>.`
    },
    ...
    {
      name: 'content',
      alias: 'valdef-flex-basis-content',
      desc: `Indicates an <a href="https://www.w3.org/TR/css-flexbox-1/#algo-main-item">automatic size</a> based on the <a href="https://www.w3.org/TR/css-flexbox-1/#flex-item">flex item</a>’s content.
(It is typically equivalent to the <a href="https://www.w3.org/TR/css-sizing-3/#max-content">max-content size</a>,
but with adjustments to handle aspect ratios,
intrinsic sizing constraints,
and orthogonal flows;
...
The equivalent effect can be achieved by using <code>auto</code> together with a main size (<a href="https://www.w3.org/TR/CSS21/visudet.html#width">width</a> or <a href="https://www.w3.org/TR/CSS21/visudet.html#height">height</a>) of <a href="https://www.w3.org/TR/css-sizing-3/#valdef-width-auto">auto</a>.</p>`
...

    {
      name: '<‘width’>',
      alias: 'width',
      desc: 'For all other values, <a href="#section-flex-basis">flex-basis</a> is resolved the same way as for <a href="https://www.w3.org/TR/CSS21/visudet.html#width">width</a> and <a href="https://www.w3.org/TR/CSS21/visudet.html#height">height</a>.'
    },
